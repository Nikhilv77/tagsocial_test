...
import secondSectionImage1 from '../assets/Images/Group 4.png'
...
const SeventhSection = () => {
  ...
  console.log("worked");
    ...
    .to(video1Elem, { scale: 1, bottom:"10%",right:"-10%" ,zIndex:5,rotation:-30,scale:1.2},)
 ...
 subElements("p").forEach((el) =>
  ...
  return (
    ...
    <Section ref={sectionRef}>
      ...
      <Text> Explore the Secure Feature Set of TagSocial. Have a question? Explore our FAQ for assistance.</Text>
      <Button>FAQs</Button>
      </TextContainer>
