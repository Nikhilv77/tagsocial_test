...
import secondSectionImage1 from '../assets/Images/hero-image.png'
...
const SeventhSection = () => {
  ...
  console.log("worked");
    ...
    .to(video1Elem, { scale: 1, bottom:"15%",right:"-3%" ,zIndex:5,scale:1},)
  ...
  return (
    ...
    <Section ref={sectionRef}>
      ...
      <Title>Discover What’s New</Title>
      <Text> Our ever-advancing features enable you to unleash your creativity through innovative means.
</Text>
        <Button>JOIN</Button>
      </TextContainer>
