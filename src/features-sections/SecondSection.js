...
import Image1 from '../assets/images/featurespage-images/section-2-1.png'
import Image2 from '../assets/images/featurespage-images/section-2-2.png'
...
const SecondSection = () => {
  ...
  useLayoutEffect(() => {
    ...
    let t2 = gsap
      ...
      .to(ImageElem1, { right: '-20%', top: 0, scale: 1 }, 'key1')
      .to(ImageElem2, { left: '-20%', top: 0, scale: 1 }, 'key1')
