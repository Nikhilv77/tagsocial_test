...
import Image1 from '../assets/images/featurespage-images/section-3-1.png'
import Image2 from '../assets/images/featurespage-images/section-3-2.png'
...
const ThirdSection = () => {
  ...
  useLayoutEffect(() => {
    ...
    let t2 = gsap
      ...
      .to(ImageElem1, { left: '-20%', top: 0, scale: 1 }, 'key1')
      .to(ImageElem2, { right: '-20%', top: 0, scale: 1 }, 'key1')
    ...
    <>
      <Section ref={sectionRef}>
        ...
        <TextContainer ref={textRef}>
          <Title>Do more with with Location based feed</Title>
          <Text>
            {' '}
      ...
      >
        <Marquee
          speed={200}
          direction="right"
          style={{ zIndex: '99', transform: 'rotate(-8deg)' }}
        >
          <MarqueeH1
