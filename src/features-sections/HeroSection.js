...
import image1 from '../assets/images/featurespage-images/hero-1.png'
import image2 from '../assets/images/featurespage-images/hero-2.png'
import image3 from '../assets/images/featurespage-images/hero-3.png'
import image4 from '../assets/images/featurespage-images/hero-4.png'
    ...
    <>
      ...
      <Section>
        ...
        <TextContainer>
          ...
          <Text>There are thrilling features waiting for you to explore.</Text>
          <div id="svgContainer" onClick={smoothScroll}>
            <svg
              ...
              id="down-arrow"
            >
              <path d="M73.8 57.9l-25 24.9C48 83.6 47 84 46 84s-2-.4-2.8-1.2l-25-24.9c-1.6-1.6-1.6-4.1 0-5.7 1.6-1.6 4.1-1.6 5.7 0L42 70.4I12c0-2.2 1.8-4 4-4s4 1.8 4 4v58.4l18.2-18.1c1.6-1.6 4.1-1.6 5.7 0 1.5 1.5 1.5 4-.1 5.6z"></path>
            </svg>
          </div>
        </TextContainer>
        <I1 src={image1} />
      ...
      >
        <Marquee
          speed={200}
          direction="right"
          style={{ zIndex: '999', transform: 'rotate(8deg)' }}
        >
          <MarqueeH1
            whileHover={{ textShadow: '0 0 20px rgba(255, 255, 255, 0.8)' }}
          >
